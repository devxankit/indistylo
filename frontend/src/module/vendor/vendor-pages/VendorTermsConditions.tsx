      ...
      <div className="px-4 py-6">
        ...
        <motion.div
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            These Terms and Conditions govern your use of the IndiStylo Vendor
            Platform. By registering as a vendor, you agree to comply with and
        ...
        <motion.div
          ...
          <p className="text-sm text-foreground leading-relaxed">
            By continuing to use IndiStylo Vendor Platform, you acknowledge that
