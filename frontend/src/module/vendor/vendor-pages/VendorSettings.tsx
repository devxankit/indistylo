...
export function VendorSettings() {
  ...
  const handleSelect = useCallback((key: keyof typeof settings, value: string | boolean) => {
  ...
  const notificationSettings: SettingItem[] = useMemo(
    ...
    [settings.pushNotifications, settings.emailNotifications, settings.smsNotifications, handleToggle]
  );
  ...
  const appSettings: SettingItem[] = useMemo(
    ...
    [settings.soundEnabled, settings.darkMode, settings.language, settings.currency, handleToggle]
  );
      ...
      >
        <div className="px-3 py-2 flex items-center gap-2">
          ...
          <div className="flex-1">
            <h1 className="text-[8px] font-medium text-foreground">Settings</h1>
            <p className="text-[6px] text-muted-foreground">Manage your app preferences</p>
          </div>
          {saved && (
            <motion.div
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {setting.type === 'select' && (
                      <select
                        ...
                        onChange={(e) => handleSelect(setting.id as keyof typeof settings, e.target.value)}
