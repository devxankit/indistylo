...
const BookingsChart = memo(({ data }: { data: any[] }) => {
  const [isLoaded, setIsLoaded] = useState(false);
...
export function VendorAnalytics() {
  ...
  const { summary, charts, performance, topServices, loading, fetchAnalytics } =
  ...
  const statsCards = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        change: summary.bookings.change,
        icon: Calendar,
      },
      {
        title: "Active Customers",
        value: summary.customers.current.toString(),
        change: summary.customers.change,
        icon: Users,
      },
      {
        title: "Average Order Value",
        value: `₹${summary.averageOrder.current.toFixed(0)}`,
  ...
  const performanceMetrics = useMemo(() => {
    ...
    return [
      ...
      { label: "Response Time", value: performance.responseTime, icon: Clock },
      {
    ...
    <div className="min-h-screen bg-background text-foreground pb-24">
                ...
                (range) => {
                  ...
                  return (
                    <motion.button
                      key={range}
                      ref={(el) => {
                        timeRangeRefs.current[range] = el;
                      }}
      ...
      <div className="px-4 py-6 space-y-6">
        ...
        <div className="bg-card border border-border rounded-xl p-5">
          ...
          <BookingsChart data={charts?.bookingsTrend || []} />
        </div>
        ...
        <motion.div
          ...
          <motion.div
            ...
            {[
              {
                label: "Completion Rate",
                value: `${performance?.completionRate.toFixed(1) || 0}%`,
                icon: CheckCircle2,
              },
              {
                label: "Customer Satisfaction",
              ...
              },
              {
                ...
                value: `${performance?.responseTime || 0}%`,
                icon: Clock,
              },
            ].map((item, index) => {
