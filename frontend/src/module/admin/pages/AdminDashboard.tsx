  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-4 py-2 !bg-red-600 !text-white hover:!bg-red-700 rounded-lg text-sm font-medium transition-colors shadow-lg shadow-red-500/20 flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatCard
          title="Total Earnings (Admin Wallet)"
          value={`₹${(stats.adminWallet || 0).toLocaleString()}`}
          trend="+12.5%"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="p-6 border-border/50 flex flex-col">
          ...
          <button
            ...
            className="w-full py-3 mt-6 text-sm font-semibold text-primary bg-primary/10 rounded-xl hover:bg-primary/20 transition-colors">
            View All Requests
          </button>
        </Card>
      </div>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-border text-left">
                  <th className="pb-3 text-sm font-medium text-muted-foreground pl-4">
                    Booking ID
                  </th>
                ...
                {recentBookings.length === 0 ? (
                  ...
                  recentBookings.map((booking) => (
                    <tr
                      ...
                      <td className="py-4">
                        <span
                          className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${booking.status === "completed"
