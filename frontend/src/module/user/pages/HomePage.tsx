...
import { mockDeals, popularAtHomeServices, popularAtHomeServicePackages } from '../services/mockData';
...
export function HomePage() {
  ...
  const handleBuyNow = (pkgId: string) => {
    const pkg = popularAtHomeServicePackages.find(p => p.id === pkgId);
    if (pkg) {
      const qty = quantity[pkgId] || 1;
      addItem(pkg, qty, 'male'); // Default to male, can be customized
      handleCloseDialog();
  ...
  const currentPackage = selectedPackage 
    ? popularAtHomeServicePackages.find(pkg => pkg.id === selectedPackage)
    : null;
      ...
      <main className="px-4 py-2 space-y-5 mx-auto mt-4">
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-1">
            <h3 className="text-lg font-bold text-foreground">Last Minute At Salon Deals</h3>
            <Link
              to="/at-salon"
                      ...
                      <div className="flex items-center justify-between text-[11px] font-medium px-1 text-white/90">
                        ...
                        {deal.salon.rating > 0 && (
                          <div className="flex items-center gap-1">
                            ...
                            <span className="tabular-nums">{deal.salon.rating}</span>
                          </div>
                        )}
                      </div>
                    </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between px-1">
            <h3 className="text-lg font-bold text-foreground">At Home Services</h3>
          </div>
        ...
        <section className="space-y-4 text-left">
          <div className="flex items-center justify-between px-1">
            <h3 className="text-lg font-bold text-foreground">Popular At Home Services</h3>
            <Link
              to="/at-home"
              className="text-yellow-400 text-sm font-semibold hover:text-yellow-500 transition-colors"
            >
          ...
          <div className="flex gap-4 overflow-x-auto pb-4 scrollbar-hide -mx-4 px-4">
            {popularAtHomeServices.map((service) => (
              <div
                key={service.id}
        ...
        <section className="space-y-4 text-left">
          <div className="flex items-center justify-between px-1">
            <h3 className="text-lg font-bold text-foreground">Popular At Home Service Packages</h3>
            <Link
              to="/at-home"
              className="text-yellow-400 text-sm font-semibold hover:text-yellow-500 transition-colors"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            {popularAtHomeServicePackages.map((pkg) => (
              <div
                key={pkg.id}
          ...
          <DialogContent className="max-h-[90vh]">
            <DialogHeader>
              <div className="flex items-start justify-between w-full text-left">
                <DialogTitle className="text-left">{currentPackage.title}</DialogTitle>
              ...
              <div className="space-y-4 text-left">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-1 text-muted-foreground">
                    <Clock className="w-4 h-4" />
                    <span className="text-sm">{currentPackage.duration} min</span>
                  </div>
                </div>

                {/* Overview Section */}
                {currentPackage.overview && currentPackage.overview.length > 0 && (
                  <div className="space-y-2">
                ...
                {currentPackage.howItWorks && currentPackage.howItWorks.length > 0 && (
                  <div className="space-y-2">
